...
Los estilos aplicados a un elemento en CSS siempre tienen que estar encerrados entre llaves \("**{}**"\). Por cada propiedad definida \(en este caso `color`\) tenemos que terminar la línea con punto y coma.
