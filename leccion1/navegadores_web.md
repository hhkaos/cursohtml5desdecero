...
Aunque existen multitud de [navegadores](https://es.wikipedia.org/wiki/Navegador_web#Ejemplos_de_navegadores_web) y de [servidores web ](https://es.wikipedia.org/wiki/Servidor_web#Software), en las lecciones que estudiemos HTML5 y CSS3 usaremos solamente Google Chrome y nuestra máquina mientras desarrollamos.