...
Esto no es responsabilidad del HTML, esto lo podremos personalizar en un futuro con CSS. Así que insisto, recuerda que HTML **sólo sirve** para dotar de estructura y darle un valor semántico al contenido, y por tanto **lo importante es entender que: lo que estamos haciendo es darle un valor semántico al mismo**.
