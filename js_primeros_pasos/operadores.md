...
Los operadores relacionales definidos por JavaScript son los mismos que los matemáticos: mayor que (>), menor que (<), mayor o igual (>=), menor o igual (<=), igual que (==) y distinto de (!=).
