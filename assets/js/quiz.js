(function ($) {
  ...
  var buildQuiz = function (input) {
    ...
    $(".quiz-container").html("<div class='progress'>Pregunta " + qnumber + "&nbsp;de&nbsp;" + input.length + "</div><div class='qq-question'><div class='qq-description'>" + input[currentQuestion].description + "</div><br><div class='question'>" + input[currentQuestion].question + "</div></div>" +
      ...
      "<button class='qq-button hint'>¿Necesitas una pista?</button>" +
  ...
  var checkAnswer = function () {
    if ($(".selected").length > 0) {
      ...
      if (answer == input[currentQuestion].answer) {
        ...
        score++;
        displayProgress();
        $(".answer").html("<p>¡Correcto!</p><p>" + input[currentQuestion].correct + "</p>");
      ...
      if (currentQuestion != (input.length-1)) {
        ...
        $(".answer").append("<button class='qq-button check-score'>Ver nota final</button>");
  ...
  var finalScore = function () {
    ...
    $(".quiz-container")
      .html("<div class='scorecard'><p>Respondiste correctamente</p><p>" + score + "&nbsp;de&nbsp;" + input.length + "</p><div id='social-media'><ul><li><a class=\"fb-share\" href='http://www.facebook.com/sharer.php?u=" + link + "' target='_blank'>" + facebook + "</a></li><li><a class=\"twitter-share\" href='http://twitter.com/home?status=Acerté " + score + "/" + input.length + " en este ejercicio " + link + " via @hhkaos' target='_blank'>" + twitter   + "</a></li><li><a class=\"gplus-share\" href='https://plus.google.com/share?url=" + link + "' target='_blank'>" + google + "</a></li></ul></div><p>¡Reta a tus amigos!</p></div>");
    $('.quiz-container .fb-share').click(function() {
      trackEvent('shared-on-fb', 'Compartir ejercicio en Facebook');
    });
    $('.quiz-container .twitter-share').click(function() {
      trackEvent('shared-on-twitter', 'Compartir ejercicio en Twitter');
    });
    $('.quiz-container .gplus-share').click(function() {
      trackEvent('shared-on-gplus', 'Compartir ejercicio en Google+');
    });
  }
